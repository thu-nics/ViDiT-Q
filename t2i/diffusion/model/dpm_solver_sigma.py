    ...
    def sample(self, x, steps=20, t_start=None, t_end=None, order=2, skip_type='time_uniform',
        ...
        with torch.no_grad():
            ...
            if method == 'adaptive':
                ...
                if return_intermediate:
                    intermediates, calib_data = save_logs(x, t, intermediates, calib_data)
            ...
            if denoise_to_zero:
                ...
                if return_intermediate:
                    intermediates, calib_data = save_logs(x, t, intermediates, calib_data)
        return (x, intermediates, calib_data) if return_intermediate else x

#############################################################
# other utility functions
#############################################################
    
def save_logs(x, t, intermediates, calib_data):
    intermediates.append(x)
    calib_data["xs"].append(x)
    calib_data["ts"].append(t)
    return intermediates, calib_data
